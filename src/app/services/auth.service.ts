...
export class AuthService {
  ...
  createStudent(firstName: string, lastName: string, email: string, day: number, month: number, year: number, country: string, region: string, district: string, homeNumber: string, phoneNumber: string, parentsPhoneNumber: string, photo: File, pdf: File, classId: number): Observable<any> {
